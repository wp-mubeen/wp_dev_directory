                                    ...
                                    <div class="sq-card-footer sq-py-0 sq-my-0 <?php echo ($view->post->sq_adm->doseo == 0) ? 'sq-mt-5' : ''; ?>">
                                        ...
                                        <div class="sq-row">
                                            ...
                                            <div class="sq-col-sm-4 sq-text-right sq-small sq-py-3 sq-px-2 sq-font-italic sq-text-black-50" style="font-size: 9px !important;">
                                                ...
                                                <?php echo (string)$view->post->post_type ?> |
                                                <?php echo esc_html__("Term", _SQ_PLUGIN_NAME_) ?>:
                                                <?php echo (string)$view->post->taxonomy ?> <br />
                                                    ...
                                                    <div class="sq-col-sm-12 sq-row sq-my-0 sq-mx-0 sq-px-0">
                                                        ...
                                                        <div class="sq-col-sm-12 sq-row sq-my-2 sq-px-0 sq-mx-0 sq-py-1 sq-px-2">
                                                            <div class="sq-col-sm-4 sq-p-0 sq-pr-3 sq-font-weight-bold">
                                                                <?php echo esc_html__("JSON-LD Schema Types", _SQ_PLUGIN_NAME_); ?>:<a href="https://howto.squirrly.co/kb/bulk-seo/#bulk_seo_snippet_jsonld" target="_blank"><i class="fa fa-question-circle sq-m-0 sq-px-1" style="display: inline; color:inherit !important;"></i></a>
                                                        ...
                                                        <div class="sq-col-sm-12 sq-row sq-my-2 sq-px-0 sq-mx-0 sq-py-1 sq-px-2">
                                                            ...
                                                            <div class="sq-col-sm-4 sq-p-0 sq-pr-3 sq-font-weight-bold">
                                                                <?php echo esc_html__("JSON-LD Breadcrumbs Schema", _SQ_PLUGIN_NAME_); ?>
                                                        ...
                                                        <?php if (SQ_Classes_Helpers_Tools::getOption('sq_jsonld_breadcrumbs') && $view->post->ID) {
                                                            ...
                                                            if (!empty($allcategories) && count($allcategories) > 1) {
                                                                ...
                                                                <div class="sq-col-sm-12 sq-row sq-my-2 sq-px-0 sq-mx-0 sq-py-1 sq-px-2">
                                                                    ...
                                                                    <div class="sq-col-sm-4 sq-p-0 sq-pr-3 sq-font-weight-bold">
                                                                        <?php echo esc_html__("Primary Category", _SQ_PLUGIN_NAME_); ?>
                                                                        <a href="https://howto.squirrly.co/kb/json-ld-structured-data/#breadcrumbs_schema" target="_blank"><i class="fa fa-question-circle sq-m-0 sq-px-1" style="display: inline; color:inherit !important;"></i></a>
                                                                        <div class="sq-small text-black-50 sq-my-1 sq-pr-4"><?php echo esc_html__("Set the Primary Category for Breadcrumbs.", _SQ_PLUGIN_NAME_); ?></div>
                                                                    </div>
                                                                    ...
                                                                    <div class="sq-col-sm-8 sq-p-0 sq-input-group">
                                                                        <select name="sq_primary_category" class="sq_primary_category sq-form-control sq-bg-input sq-mb-1">
                                                                            ...
                                                                            foreach ($allcategories as $id => $category) { ?>
                                                                                <option <?php echo(($id == $view->post->sq_adm->primary_category) ? 'selected="selected"' : '') ?> value="<?php echo $id ?>">
                                                        ...
                                                        <?php if ($view->post->post_type == 'product') { ?>
                                                            <div class="sq-col-sm-12 sq-row sq-my-2 sq-px-0 sq-mx-0 sq-py-1 sq-px-2">
                                                                ...
                                                                <div class="sq-col-sm-4 sq-p-0 sq-pr-3 sq-font-weight-bold">
                                                                    <?php echo esc_html__("Woocommerce Product Support", _SQ_PLUGIN_NAME_); ?>
                                                        ...
                                                        <?php if (SQ_Classes_Helpers_Tools::getOption('sq_seoexpert')) { ?>
                                                            <div class="sq-col-sm-12 sq-row sq-my-2 sq-px-0 sq-mx-0 sq-py-1 sq-px-2 ">
                                                                ...
                                                                <div class="sq-col-sm-4 sq-p-0 sq-pr-3 sq-font-weight-bold">
                                                                    <?php echo esc_html__("Remove other JSON-LD Schema", _SQ_PLUGIN_NAME_); ?>
                                                            ...
                                                            <div class="sq-col-sm-12 sq-row sq-my-2 sq-px-0 sq-mx-0 sq-py-1 sq-px-2">
                                                                ...
                                                                <div class="sq-col-sm-12 sq-row sq-p-0 sq-m-0">
                                                                    <div class="sq-col-sm-4 sq-p-0 sq-pr-3 sq-font-weight-bold">
                                                                        <?php echo esc_html__("JSON-LD Code", _SQ_PLUGIN_NAME_); ?>:<a href="https://howto.squirrly.co/kb/bulk-seo/#jsonld_custom_code" target="_blank"><i class="fa fa-question-circle sq-m-0 sq-px-1" style="display: inline; color:inherit !important;"></i></a>
