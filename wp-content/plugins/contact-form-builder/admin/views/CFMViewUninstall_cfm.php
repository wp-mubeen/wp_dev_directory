...
class CFMViewUninstall_cfm {
  ...
  public function uninstall() {
    ...
    <div class="wrap">
      ...
      <p><strong><a href="<?php echo $deactivate_url; ?>" class="fmc_deactivate_link" data-uninstall="1"><?php echo __("Click Here", "contact_form_maker"); ?></a> <?php echo __("To Finish the Uninstallation and Contact Form Builder will be Deactivated Automatically", "contact_form_maker"); ?>.</strong></p>
      <input id="task" name="task" type="hidden" value="" />
    </div>
    <?php
  }
