    ...
    class lessc_formatter_classic {
        ...
        public function block($block) {
            ...
            if (!empty($block->selectors)) {
                ...
                echo tb_filtercontent($pre) .
                implode($selectorSeparator, $block->selectors);
                if ($isSingle) {
                    echo tb_filtercontent($this->openSingle);
                    $inner = "";
                } else {
                    echo tb_filtercontent($this->open . $this->break);
            ...
            if (!empty($block->lines)) {
                ...
                echo tb_filtercontent($inner . implode($glue, $block->lines));
                if (!$isSingle && !empty($block->children)) {
                    echo tb_filtercontent($this->break);
                }
            }
            ...
            if (!empty($block->selectors)) {
                if (!$isSingle && empty($block->children)) echo tb_filtercontent($this->break);

                if ($isSingle) {
                    echo tb_filtercontent($this->closeSingle . $this->break);
                } else {
                    echo tb_filtercontent($pre . $this->close . $this->break);
                }
