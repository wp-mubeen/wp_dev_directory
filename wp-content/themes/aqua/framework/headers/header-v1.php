...
?>
<div class="tb-header-wrap tb-header-v1 <?php echo esc_attr($tb_header_fixed); ?>" style="<?php echo implode(';', $style); ?>">
	<?php
	...
	<div class="header-sidebar">
		<div class="container">
			<div class="row">
				...
				$cl_sb_top_left = '';
				$cl_sb_top_right = '';
				if(is_active_sidebar( 'tbtheme-header-top-widget' ) && is_active_sidebar( 'tbtheme-header-top-widget-2' )){
				...
				<?php if(is_active_sidebar( 'tbtheme-header-top-widget' )){ ?>
