...
class tb_FrameworkMetaboxes {
	...
	public function add_meta_boxes()
	{
		...
		$this->add_meta_box('post_options', __('Page Options','aqua'), 'page');
		$this->add_meta_box('post_default', __('Note Settings','aqua'), 'post');
		$this->add_meta_box('post_video', __('Video Settings','aqua'), 'post');
		$this->add_meta_box('post_audio', __('Audio Settings','aqua'), 'post');
		$this->add_meta_box('post_quote', __('Quote Settings','aqua'), 'post');
		$this->add_meta_box('post_link', __('Link Settings','aqua'), 'post');
		$this->add_meta_box('post_team', __('Team Settings','aqua'), 'team');
	}
...
$metaboxes = new tb_FrameworkMetaboxes();