<?php
function tb_post_carousel_render($atts, $content = null) {
	global $post;
	...
	include ABS_PATH."/framework/shortcodes/post_carousel/tpl/{$tpl}.php";
    wp_reset_postdata();
    return ob_get_clean();
}
if(function_exists('insert_shortcode')) {
	insert_shortcode('tb_post_carousel', 'tb_post_carousel_render');
}