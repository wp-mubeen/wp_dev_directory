...
?>
<div id="<?php echo esc_attr($uniqid); ?>" class="tb-carousel owl-carousel owl-theme <?php echo esc_attr($el_class); ?>" <?php echo tb_filtercontent($data_attr);?>>
						...
						<?php if ($show_info) : ?>
							<div class="tb_info_blog">
								<div class="tb_meta_blog">
									<span class="time"><?php echo get_the_time('d'); ?></span>
