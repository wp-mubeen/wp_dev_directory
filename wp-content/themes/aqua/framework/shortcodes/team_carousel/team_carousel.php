<?php
function tb_team_carousel_render($atts, $content = null) {
	global $post;
	...
	include ABS_PATH."/framework/shortcodes/team_carousel/tpl/{$tpl}.php";
    wp_reset_postdata();
    return ob_get_clean();
}
if(function_exists('insert_shortcode')) {
	insert_shortcode('tb_team_carousel', 'tb_team_carousel_render');
}