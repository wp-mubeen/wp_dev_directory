<?php
function tb_maps_render($params, $content = null) {
    ...
    wp_enqueue_script('maps-apiv3', URI_PATH_FR . "/shortcodes/maps/maps.js",array(),'1.0.0');
    /* Map Style defualt */
    $map_styles = array(
    ...
    if($markercoordinate){
    	...
    	$marker->markerdesc = 	'<div class="tb-maps-info-content">'.
    							'<h5>'.$markertitle.'</h5>'.
...
if(function_exists('insert_shortcode')) { insert_shortcode('maps', 'tb_maps_render'); }