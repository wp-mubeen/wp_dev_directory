<?php
function tb_client_carousel_render($atts, $content = null) {
	global $post;
	...
	include ABS_PATH."/framework/shortcodes/client_carousel/tpl/{$tpl}.php";
    wp_reset_postdata();
    return ob_get_clean();
}
if(function_exists('insert_shortcode')) {
	insert_shortcode('tb_client_carousel', 'tb_client_carousel_render');
}