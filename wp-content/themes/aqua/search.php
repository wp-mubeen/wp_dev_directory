				...
				switch ($tb_blog_layout) {
					...
					case '2cl':
						if(is_active_sidebar( 'tbtheme-left-sidebar' )){
							$cl_content = 'col-xs-12 col-sm-8 col-md-8 col-lg-8';
							$cl_sb_left = 'col-xs-12 col-sm-4 col-md-4 col-lg-4';
						}
						break;
					case '2cr':
						if(is_active_sidebar( 'tbtheme-right-sidebar' )){
							$cl_content = 'col-xs-12 col-sm-8 col-md-8 col-lg-8';
							$cl_sb_right = 'col-xs-12 col-sm-4 col-md-4 col-lg-4';
						}
						break;
					case '3cm':
						if(is_active_sidebar( 'tbtheme-left-sidebar' ) && is_active_sidebar( 'tbtheme-right-sidebar' )){
							$cl_content = 'col-xs-12 col-sm-4 col-md-4 col-lg-4';
							$cl_sb_left = 'col-xs-12 col-sm-4 col-md-4 col-lg-4';
							$cl_sb_right = 'col-xs-12 col-sm-4 col-md-4 col-lg-4';
						}else{
							if(is_active_sidebar( 'tbtheme-left-sidebar' )){
