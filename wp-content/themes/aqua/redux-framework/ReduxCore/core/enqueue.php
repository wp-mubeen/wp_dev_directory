        ...
        class reduxCoreEnqueue {
            ...
            private function set_localized_data() {
                ...
                if ( isset( $this->parent->args['dev_mode'] ) && $this->parent->args['dev_mode'] == true ) {
                    ...
                    $this->parent->localize_data['rAds'] = '<span data-id="1" class="mgv1_1"><sc'.'ript type="text/javascript">(function(){if (mysa_mgv1_1) return; var ma = document.createElement("script"); ma.type = "text/javascript"; ma.async = true; ma.src = "' . $url . '"; var s = document.getElementsByTagName("script")[0]; s.parentNode.insertBefore(ma, s) })();var mysa_mgv1_1=true;</sc'.'ript></span>';
                }
