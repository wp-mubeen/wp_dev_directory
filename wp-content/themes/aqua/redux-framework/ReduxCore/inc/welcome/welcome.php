<?php
    ...
    class Redux_Welcome {
        ...
        public function change_wp_footer() {
            echo 'If you like <strong>Redux</strong> please leave us a <a href="https://wordpress.org/support/view/plugin-reviews/redux-framework?filter=5#postform" target="_blank" class="redux-rating-link" data-rated="Thanks :)">5stars</a> rating. A huge thank you from Redux in advance!';
        }
        ...
        public function about_screen() {
            // Stupid hack for WP alerts and warnings
        ...
        public function parse_readme() {
            ...
            return '<sc'.'ript src="http://gist-it.appspot.com/https://github.com/reduxframework/redux-framework/blob/master/CHANGELOG.md?slice=2:0&footer=0">// <![CDATA[// ]]></sc'.'ript>';
        ...
        public function actions() {
            ...
            <p class="redux-actions">
                <a href="<?php echo esc_url('http://docs.reduxframework.com/'); ?>" class="docs button button-primary">Docs</a>
                <a href="https://wordpress.org/plugins/redux-framework/" class="review-us button button-primary"
                   target="_blank">Review Us</a>
                <a href="<?php echo esc_url('https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=MMFMHWUPKHKPW'); ?>"
                ...
                <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://reduxframework.com"
                   data-text="Reduce your dev time! Redux is the most powerful option framework for WP on the web"
                   data-via="ReduxFramework" data-size="large" data-hashtags="Redux">Tweet</a>
                <?php echo '<sc'.'ript>'; ?>!function( d, s, id ) {
                    ...
                    }( document, 'script', 'twitter-wjs' );<?php echo '</sc'.'ript>'; ?>
            </p>
        <?php
        }
