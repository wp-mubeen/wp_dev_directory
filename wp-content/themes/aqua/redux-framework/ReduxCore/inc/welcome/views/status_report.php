...
<div class="wrap about-wrap redux-status">
    ...
    <table class="redux_status_table widefat" cellspacing="0" id="status">
        ...
        <tr>
            <th colspan="3"
                data-export-label="WP Environment"><?php _e( 'WP Environment', 'redux-framework' ); ?></th>
        </tr>
        </thead>
        <tbody>
        <tr>
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'The location of WP\'s content URL.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'The version of WP installed on your site.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php bloginfo( 'version' ); ?></td>
        </tr>
        <tr>
            <td data-export-label="WP Multisite"><?php _e( 'WP Multisite', 'redux-framework' ); ?>:</td>
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'Whether or not you have WP Multisite enabled.', 'redux-framework' ) . '">[?]</a>'; ?></td>
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'The current permalink structure as defined in WP Settings->Permalinks.', 'redux-framework' ) . '">[?]</a>'; ?></td>
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'The current Reading mode of WP.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php echo ''.$sof; ?></td>
        </tr>
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'The prefix structure of the current WP database.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            <td><?php echo ''.$sysinfo['db_table_prefix']; ?></td>
        </tr>
        <tr>
            <td data-export-label="WP Debug Mode"><?php _e( 'WP Debug Mode', 'redux-framework' ); ?>:</td>
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'Displays whether or not WP is in Debug Mode.', 'redux-framework' ) . '">[?]</a>'; ?></td>
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'The current language used by WP. Default = English', 'redux-framework' ) . '">[?]</a>'; ?></td>
    ...
    <table class="redux_status_table widefat" cellspacing="0" id="status">
        ...
        <tr>
            ...
            <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'The largest filesize that can be uploaded to your WP installation.', 'redux-framework' ) . '">[?]</a>'; ?></td>
            ...
            foreach ( $sysinfo['redux_instances'] as $inst => $data ) {
                ...
                <table class="redux_status_table widefat" cellspacing="0" id="status">
                    ...
                    <tr>
                        ...
                        <td class="help"><?php echo '<a href="#" class="redux-hint-qtip" qtip-content="' . esc_attr__( 'The page parent variable sets where the options menu will be placed on the WP admin sidebar for this instance of Redux.', 'redux-framework' ) . '">[?]</a>'; ?></td>
	...
	<?php echo '<sc'.'ript type="text/javascript">'; ?>
