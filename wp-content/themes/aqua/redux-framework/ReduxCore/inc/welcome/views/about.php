            ...
            <div class="wc-feature feature-section col three-col">
                ...
                <div>
                    ...
                    <p>We've gone back to the drawing boards and made Redux the <strong>simplist</strong> framework to
                        ...
                        having to define a class! <a href="<?php echo esc_url('http://docs.reduxframework.com/core/redux-api/'); ?>" target="_blank">Learn More</a></p>
                </div>
            ...
            <div class="feature-section col three-col">
                <div>
                    ...
                    <p>Now developers can easily customize the Redux panel by declaring a templates location path. We've
                        also made use of template versioning so if we change anything, you will know. <br /><a href="<?php echo esc_url('http://docs.reduxframework.com/core/templates/'); ?>" target="_blank">Learn More</a></p>
                </div>
                <div>
