...
SKY.Carousel.prototype = {
    ...
    initContentWrapper: function() {
        ...
        this.contentContainer.append('<div class="sc-content"><h2></h2><div class="tb-content"></div></div>');
    ...
    setCurrentContent: function(a) {
        0 < a.content.length ? (this.contentContainer.find("h2").html(a.content.children("h2").html()),
            this.contentContainer.find("div.tb-content").html(a.content.children("div.cur_content").html())) : (this.contentContainer.find("h2").empty(), this.contentContainer.find("p").empty())
    },
